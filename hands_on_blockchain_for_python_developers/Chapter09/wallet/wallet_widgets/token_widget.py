...
from blockchain import SendTransaction, TokenInformation, blockchain
...
class TokenWidget(QWidget):
    ...
    def watchNewToken(self):
        address, ok = QInputDialog.getText(self, "Watch A New Token", "Token Smart Contract:", QLineEdit.Normal)
        if ok and address != "":
