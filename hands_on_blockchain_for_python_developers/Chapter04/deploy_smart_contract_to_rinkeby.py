...
with open(
    "/opt/data/ethereumdata/keystore/UTC--2018-10-12T09-30-20.687898000Z--28f5b56b035da966afa609f65fd8f7d71ff68327"
) as keyfile:
...
transaction = HelloSmartContract.constructor().buildTransaction(
    {"from": Web3.toChecksumAddress(from_account), "gas": 500000, "gasPrice": w3.toWei("30", "gwei"), "nonce": nonce}
)
