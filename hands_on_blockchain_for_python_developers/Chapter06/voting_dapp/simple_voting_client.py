...
abi = [
    {
        ...
        "inputs": [
            ...
            {"indexed": false, "name": "_proposal", "type": "int128"},
        ],
        "name": "Voting",
        "type": "event",
    },
    {
        "constant": false,
        "inputs": [{"name": "_proposalNames", "type": "bytes32[2]"}],
        "name": "__init__",
        "outputs": [],
        "payable": false,
        "type": "constructor",
    },
    {
        "constant": false,
        "gas": 73421,
        "inputs": [{"name": "proposal", "type": "int128"}],
        "name": "vote",
        "outputs": [],
        "payable": false,
        "type": "function",
...
txn = SimpleVoting.functions.vote(0).buildTransaction({"gas": 70000, "gasPrice": w3.toWei("1", "gwei"), "nonce": nonce})
