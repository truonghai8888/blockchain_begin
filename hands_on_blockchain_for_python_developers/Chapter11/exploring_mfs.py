...
c.files_write("/classical_movies/titanic", io.BytesIO(b"The ship crashed. The end."), create=True)

print("We can copy a file in our MFS.")
c.files_cp("/classical_movies/titanic", "/classical_movies/copy_of_titanic")
