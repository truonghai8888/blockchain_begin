...
_DATA_DATATYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="Raw", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="Directory", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="File", index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="Metadata", index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="Symlink", index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="HAMTShard", index=5, number=5, options=None, type=None),
    ],
